...
import '../index.css'
import './nav.css'
import Sidebarflowbite from './Sidebarflowbite';
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <div class="text-center">
                <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target={Sidebarflowbite} data-drawer-show={Sidebarflowbite} aria-controls="drawer-navigation">
                    Show navigation
                </button>
            </div>
